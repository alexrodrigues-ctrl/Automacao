...
{
    public class DCategoria //Classe Dados da Categoria // vamos deixa-la publica p/ ser acessivel em outras classes
    {
        ...
        public string Inserir(DCategoria Categoria)
        {
            ...
            //por ser um metodo tipo string preciso dá o return, ou seja, o retorno. aqui vou retorna a var resp que contem -resp = ex.Message;-
            return resp;
        }
        //Metodo EDITAR
        ...
        //METODO MOSTRAR sem Paramentros
        public DataTable Mostrar() //pq DataTable? pq sera mostrado numa tabela, listbox, grind, etc
        {
            ...
            try
            {
                ...
                SqlCmd.CommandType = CommandType.StoredProcedure;
                SqlDataAdapter sqlDat = new SqlDataAdapter(SqlCmd);//precisa para guardar ou exibir numa tabela ou lisbox.
                sqlDat.Fill(DtResultado); // preencher as informacoes, da tabela DtResultado

            }
            catch (Exception ex)
            {
                //se o teste -try- falhar o catch DtResultado vai ficar vazio, null
                DtResultado = null;
            }
            return DtResultado; //retornando o DtResultado.
